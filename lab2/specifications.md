...
-poibil sa existe filtrari(ex. dupa cine castiga mai mult,nume etc..) BUTON DE FILTRARE + SELECTIE FILTRU
...
Reguli de calcul:
salariu lunar = salariu_pe_zi × zile_lucrate (INITIAL SALAITU ZI X CATE ZILE ARE LUNA)
